...
//        BufferedImage img = TiffReader.readTiffImage(new File("D:\\Documents\\IdependentContracting\\Carrol Lab\\LRP Analysis App\\Example Human OCTs\\Normal\\AVG_RW_10174_OD_L_7_0_02_529disp_25frames.tif"));
//        BufferedImage img = TiffReader.readTiffImage(new File("D:\\Documents\\IdependentContracting\\Carrol Lab\\LRP Analysis App\\Example Human OCTs\\Normal\\AVG_RW_10174_OD_L_7_90_05_529disp_27frames.tif"));
        BufferedImage img = TiffReader.readTiffImage(new File("D:\\Documents\\IdependentContracting\\Carrol Lab\\LRP Analysis App\\Example Human OCTs\\Normal\\AVG_RW_10174_OS_Raw_L_90.tif"));
...
//        UnivariateInterpolator interpolator = new LoessInterpolator(0.1, 0);//good for identifying the true foveal center
        UnivariateInterpolator interpolator = new LoessInterpolator(0.35,2);//good for removing and identifying relative vicinity of foveal center
