...
/**
 * 
 * This class performs all of the tiff reading functions that you could require in reading tiff images.
 * NOTE: This program requires the JAI imageIO library, or it will not function correctly!
 * 
 * Version 1.0: Reads tiff images and tiff stacks.
 * Version 1.1: Reads tiff stacks to an ArrayList instead of an array of BufferedImages
 * 
 */
public class TiffReader {
   ...
   public static ArrayList<BufferedImage> readTiffStack(File file) throws IOException{
        ...
        try {
            ...
            while(imageStk.add(tiffStkReader.read(i))){  i++; }
